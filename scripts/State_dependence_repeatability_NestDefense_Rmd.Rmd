...
```{r vcov1, include=T, warning=F, message=F}
smfixef
```

#### **Covariance matrix random effects**

```{r vrcov1, include=T, warning=F, message=F}
smranef
```
...
```{r vcov22, include=T, warning=F, message=F}
smfixef
```

#### **Covariance matrix random effects**

```{r vrcov22, include=T, warning=F, message=F}
smranef
```
...
```{r vcov33, include=T, warning=F, message=F}
smfixef
```

#### **Covariance matrix random effects**

```{r vrcov33, include=T, warning=F, message=F}
smranef
```
...
```{r vcov44, include=T, warning=F, message=F}
smfixef
```

#### **Covariance matrix random effects**

```{r vrcov44, include=T, warning=F, message=F}
smranef
```
...
require(readr)
# Set wd
data3c<- read_csv("C:/Users/nickg/OneDrive/Desktop/R projects/krmp_nest-defense/data/nest_defense_test_final_20220318.csv")
names(data3c)
...
```{r vcov4423454, include=T, warning=F, message=F}
m3FID$Sol
```

#### **Covariance matrix random effects**

```{r vrcov44234453, include=T, warning=F, message=F}
m3FID$VCV
```
...
```{r vcov445, include=T, warning=F, message=F}
m3Min$Sol
```

#### **Covariance matrix random effects**

```{r vrcov445, include=T, warning=F, message=F}
m3Min$VCV
```
...
```{r vcov4455, include=T, warning=F, message=F}
m3Dives$Sol
```

#### **Covariance matrix random effects**

```{r vrcov4455, include=T, warning=F, message=F}
m3Dives$VCV
```
...
```{r vcov44566, include=T, warning=F, message=F}
model.2var$Sol
```

#### **Covariance matrix random effects**

```{r vrcov44566, include=T, warning=F, message=F}
model.2var$VCV
```
...
```{r vcov133332, include=T, warning=F, message=F}
smod@fixef
```

#### **Covariance matrix random effects**

```{r vrcov133332, include=T, warning=F, message=F}
smod@ranef
```
...
```{r vrcov44999898, include=T, warning=F, message=F}
mod.12$VCV
```
...
```{r vrcov4394845754, include=T, warning=F, message=F}
mod.13$VCV
```
...
```{r vrcov477655421234, include=T, warning=F, message=F}
mod.122$VCV
```
